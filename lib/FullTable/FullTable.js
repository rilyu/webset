...
var _AnimationFrame = _interopRequireDefault(require("../ScrollView/AnimationFrame"));
...
var FullTable = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(FullTable, [{
    ...
    value: function render() {
      var _this4 = this;
      var checkLayout = function checkLayout(v) {
        if (!v) return;
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        ref: function ref(v) {
          return _this4.fullTableContainer = v;
        }
      }, /*#__PURE__*/_react.default.createElement(_AnimationFrame.default, {
        onEvent: function onEvent() {
          return checkLayout(_this4.fullTableContainer);
        }
