  ...
  (0, _createClass2.default)(Form, [{
    ...
    value: function register(field) {
      ...
      if (field && field.titleElement) {
        var _field$titleElement$g = field.titleElement.getBoundingClientRect(),
            width = _field$titleElement$g.width;
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          others = (0, _objectWithoutProperties2.default)(_this$props, ["className", "mode", "fieldProps", "value"]);
