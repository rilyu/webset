  ...
  (0, _createClass2.default)(Field, [{
    ...
    value: function buildProps() {
      ...
      for (var key in this.mergeProps) {
        ...
        else if (this.constructor.colPropKeySet[key]) this.colProps[key] = this.mergeProps[key];else if (this.constructor.fieldPropTypes[key] === undefined) this.otherProps[key] = this.mergeProps[key];
      }
    }
  }, {
    key: "error",
    ...
    value: function renderField(formContext) {
      ...
      var sizeClassName = "ws-field-".concat(size || 'default');
      return /*#__PURE__*/_react.default.createElement(_antd.Col, (0, _extends2.default)({}, this.colProps, {
        className: "ws-field ".concat(this.fieldClassName, " ").concat(modeClassName, " ").concat(titleModeClassName, " ").concat(errorClassName, " ").concat(sizeClassName)
...
Field.colPropKeySet = ['span', 'order', 'offset', 'push', 'pull', 'className', 'children', 'xs', 'sm', 'md', 'lg', 'xl', 'xxl'].reduce(function (result, item) {
  return Object.assign(result, (0, _defineProperty2.default)({}, item, true));
}, {});
Field.fieldPropTypes = {
  mode: _propTypes.default.oneOf(['form', 'edit', 'view', 'string', 'concise']),
...
Field.propTypes = _objectSpread(_objectSpread({}, _antd.Col.propTypes), Field.fieldPropTypes);
