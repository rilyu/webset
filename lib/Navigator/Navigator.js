  ...
  (0, _createClass2.default)(Navigator, [{
    ...
    value: function () {
      var _close = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(uri) {
        var path, _this$state2, activePath, pageSet, keys, index;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this$state2 = this.state, activePath = _this$state2.activePath, pageSet = _this$state2.pageSet;
              ...
              case 8:
                if (path === activePath) {
                  ...
                  if (index + 1 < keys.length) activePath = keys[index + 1];else if (index - 1 >= 0) activePath = keys[index - 1];else activePath = null;
                }
    ...
    value: function initPageSet() {
      ...
      var _iterator = _createForOfIteratorHelper(this.defaultOpenUris),
          _step;
    ...
    value: function getQueryParams(queryString) {
      ...
      var _iterator3 = _createForOfIteratorHelper((queryString || '').split('&')),
          _step3;
