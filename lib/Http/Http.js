...
var _excluded = ["url", "params", "options"],
  _excluded2 = ["body", "method"],
  _excluded3 = ["success", "response"],
  _excluded4 = ["body", "headers"],
  _excluded5 = ["success", "data", "response", "options"],
  _excluded6 = ["body"],
  _excluded7 = ["success", "data", "options"],
  _excluded8 = ["body"],
  _excluded9 = ["body"],
  _excluded10 = ["success", "data", "options"];
  ...
  (0, _createClass2.default)(Http, [{
      ...
      var _callCache = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee10(func, _ref10) {
        ...
        return _regenerator.default.wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              url = _ref10.url, params = _ref10.params, options = _ref10.options, others = (0, _objectWithoutProperties2.default)(_ref10, _excluded);
    ...
    value: function baseEncode(_ref14) {
      ...
      var _ref15 = options || {},
        ...
        others = (0, _objectWithoutProperties2.default)(_ref15, _excluded2);
    ...
    value: function baseDecode(_ref16) {
      var success = _ref16.success,
        ...
        others = (0, _objectWithoutProperties2.default)(_ref16, _excluded3);
      if (response.ok) {
    ...
    value: function textEncode(_ref17) {
      ...
      var _ref18 = options || {},
        ...
        others = (0, _objectWithoutProperties2.default)(_ref18, _excluded4);
      ...
      var _textDecode = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee15(_ref19) {
        ...
        return _regenerator.default.wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            case 0:
              success = _ref19.success, data = _ref19.data, response = _ref19.response, options = _ref19.options, others = (0, _objectWithoutProperties2.default)(_ref19, _excluded5);
              _context15.next = 3;
    ...
    value: function jsonEndode(_ref20) {
      ...
      var _ref21 = options || {},
        body = _ref21.body,
        others = (0, _objectWithoutProperties2.default)(_ref21, _excluded6);
    ...
    value: function jsonDecode(_ref22) {
      var success = _ref22.success,
        ...
        others = (0, _objectWithoutProperties2.default)(_ref22, _excluded7);
    ...
    value: function formDataEncode(_ref23) {
      ...
      var _ref24 = options || {},
        body = _ref24.body,
        others = (0, _objectWithoutProperties2.default)(_ref24, _excluded8);
      ...
      var addValue = function addValue(name, value) {
        if (!value) {
          ...
          for (var i = 0; i < value.length; ++i) addValue("".concat(name, "[").concat(i, "]"), value[i]);
        } else if (value instanceof Object) {
          for (var key in value) addValue("".concat(name, ".").concat(key), value[key]);
        } else {
          formData.append(name, value);
        }
      };
    ...
    value: function uploadEncode(_ref25) {
      ...
      var _ref26 = options || {},
        body = _ref26.body,
        others = (0, _objectWithoutProperties2.default)(_ref26, _excluded9);
    ...
    value: function uploadDecode(_ref27) {
      var success = _ref27.success,
        ...
        others = (0, _objectWithoutProperties2.default)(_ref27, _excluded10);
