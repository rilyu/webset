...
var _excluded = ["onClick"],
    _excluded2 = ["className", "components", "locale", "rowSelection", "rangeSelect", "onRow"];
  ...
  (0, _createClass2.default)(HoldTable, [{
    ...
    value: function render() {
      ...
      var calcHeight = function calcHeight(v) {
        ...
        if (!isNaN(paginationHeight) && paginationHeight !== _this4.state.paginationHeight) _this4.setState({
