...
var _excluded = ["onClick"],
  _excluded2 = ["className", "style", "components", "locale", "rowSelection", "rangeSelect", "onRow"];
...
var HoldTable = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(HoldTable, [{
    ...
    value: function componentDidMount() {
      var _this2 = this;
      this.isMount = true;
      this.shiftKeyHandler = function (e) {
        return _this2.isMount && e.shiftKey !== _this2.state.shiftKey && _this2.setState({
          shiftKey: e.shiftKey
        });
      };
    ...
    value: function renderEmpty() {
      ...
      var changePlaceholderHeight = function changePlaceholderHeight(v) {
        if (v && v.parentNode && v.parentNode.previousSibling && holdHeight > 0) {
          ...
          var siblingHeight = _this3.getNodeHeight(v.parentNode.previousSibling);
    ...
    value: function onRow(record, index) {
      ...
      return _objectSpread(_objectSpread({}, others), {}, {
        onClick: function onClick(e) {
          if (rangeSelect && e.shiftKey && _this4.startIndex !== undefined && _this4.startDataSource === dataSource) {
            var selectedRowKeys = [],
              selectedRows = [];
            var startIndex = Math.min(_this4.startIndex, index),
              endIndex = Math.max(_this4.startIndex, index);
            ...
            _this4.startIndex = index;
            _this4.startDataSource = dataSource;
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
        ...
        others = (0, _objectWithoutProperties2.default)(_this$props4, _excluded2);
      var calcHeight = function calcHeight(v) {
        if (!v) return;
        var domNode = _reactDom.default.findDOMNode(v);
        var paginationHeight = Math.floor(_this5.getNodeHeight(domNode.querySelector('ul.ant-pagination.ant-table-pagination')));
        if (!isNaN(paginationHeight) && paginationHeight !== _this5.state.paginationHeight) _this5.setState({
      ...
      return /*#__PURE__*/_react.default.createElement(_antd.Table, (0, _extends2.default)({}, others, {
        ...
        style: _objectSpread(_objectSpread({}, style), {}, {
          userSelect: this.state.shiftKey ? 'none' : undefined
        }),
